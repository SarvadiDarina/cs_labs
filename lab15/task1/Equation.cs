...
namespace task1
{
    class Equation :IMatrix2, IMatrix3
    {
        ...
        // задані значення коефіцієнтів системи дво лінійних рівнянь
        voidIMatrix2.SetValues(ref Equation mtrx)
        {
            for (int i = 0; i < 2; i++)
            {
                for (int j = 0; j < 3; j++)
        ...
        // знаходить корені системи дво лінійних рівнянь, використовуючи детермінант
        voidIMatrix2.Solution(out double x1, out double x2)
        {
        ...
        // виводить систему дво лінійних рівнянь
        voidIMatrix2.EquationOutput()
        {
            Console.WriteLine($" {Matrix[0, 0]}x+{Matrix[0, 1]}y = {Matrix[0, 2]}\n {Matrix[1, 0]}x+{Matrix[1, 1]}y = {Matrix[1, 2]}");
        }


        // задані значення коефіцієнтів системи три лінійних рівнянь
        void IMatrix3.SetValues(ref Equation mtrx)
        {
            for (int i = 0; i < 3; i++)
            {
                for (int j = 0; j < 4; j++)
        ...
        // знаходить корені системи три лінійних рівнянь, використовуючи визначник
        void IMatrix3.Solution(out double x1, out double x2, out double x3)
        {
        ...
        // виводить систему три лінійних рівнянь
        void IMatrix3.EquationOutput()
        {
